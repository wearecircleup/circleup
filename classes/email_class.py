...
# class Email:
#     sender: str = 'wearecircleup@gmail.com'
#     password:str = 'fjmn jryj zzcy ofuh'
#     bcc: str = 'danielnicolasmuner@gmail.com'
#     smtp_server: str = 'smtp.gmail.com'
#     smtp_port: int = 465
    

#     def send_pensum(self,recipient,data):
...
#         try:
#             server = smtplib.SMTP_SSL(host=self.smtp_server,port=self.smtp_port,context=context)
#             server.ehlo()
#             server.login(self.sender,self.password)
#             server.sendmail(from_addr=self.sender,to_addrs=[recipient, self.bcc],msg=message.as_string())
