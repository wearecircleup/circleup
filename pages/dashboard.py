...
def manage_volunteer_requests(connector: Firestore):
    ...
    st.info("Bienvenido a tu panel de control. Aquí podrás revisar el estado de tus propuestas, gestionar la asistencia de los participantes y marcar la finalización de tus cursos. Selecciona una propuesta para ver detalles y estadísticas.", icon=":material/stadia_controller:")
    
    status_options = ["Pending", "Approved", "Denied"]
    selected_status = st.selectbox("Selecciona el estado de la propuesta:", status_options)
