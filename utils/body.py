...
<div style="position: relative; width: 100%; padding: 10px;">
    <div style="border-radius: 10px; overflow: hidden;">
        <img src="https://i.ibb.co/ynFh5Ww/streamlit.jpg" alt="Imagen de fondo" style="width: 100%; height: auto;">
    </div>
</div>
"""
...
<div style="position: relative; width: 100%; padding: 10px;">
    <div style="border-radius: 15px; overflow: hidden;">
        <img src="https://i.ibb.co/BfKB38H/home.png" alt="Imagen de fondo" style="width: 100%; height: auto;">
    </div>
</div>
"""
...
@st.experimental_dialog("¡Email Enviado con Éxito!")
